...
public class TestHttpSinkIT {
    ...
    @RegisterExtension
    public static final WireMockExtension service =
            WireMockExtension.newInstance().options(wireMockConfig().port(port)).build();
    ...
    public void ensureEventsResentOn503Failure() throws Exception {
        ...
        service.verify(
                2, postRequestedFor(urlEqualTo("/endpoint")).withRequestBody(equalToJson(event("TRANSIENT_ERROR"))));
    }
    ...
    public void ensureEventsNotResentOn401Failure() throws Exception {
        ...
        service.verify(
                1,
                postRequestedFor(urlEqualTo("/endpoint")).withRequestBody(equalToJson(event("UNAUTHORIZED REQUEST"))));
    ...
    public void ensureEventsResentOnNetworkFailure() throws Exception {
        ...
        service.verify(
                2, postRequestedFor(urlEqualTo("/endpoint")).withRequestBody(equalToJson(event("NETWORK_ERROR"))));
    }
    ...
    public void ensureEventsResentOnRequestTimeout() throws Exception {
        ...
        service.verify(
                2, postRequestedFor(urlEqualTo("/endpoint")).withRequestBody(equalToJson(event("SLOW_RESPONSE"))));
    }
