...
class TestResendEvent {
    ...
    @Test
    void ensureEventsResentOnConnectionTimeout() throws Exception {
        // Set the initial connection timeout delay using the client instance
        service.getRuntimeInfo().getWireMock().setGlobalFixedDelayVariable(CONNECT_TIMEOUT);
        ...
        // Wait until the extension's ServeEventListener interceptor fires
        firstRequestReceived.await(CONNECT_TIMEOUT + 1000, TimeUnit.MILLISECONDS);
